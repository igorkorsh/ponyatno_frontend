...
import { ITeacher } from "@/types/profile.types"
		...
		<div className='flex flex-col gap-3'>
			...
			<div className='relative flex items-center gap-4 rounded-lg bg-neutral-100 p-4 transition-all max-lg:flex-col lg:gap-[46px] lg:p-6'>
				...
				<Avatar size='lg'>
					...
					{(data as ITeacher).isVerified && <IsVerified />}
				</Avatar>
				<div className='flex flex-col gap-4'>
					<div className='flex items-center gap-2 max-lg:flex-col lg:gap-4'>
						<p className='text-center text-xl font-semibold text-neutral-900 lg:text-2xl'>
							{data.firstName || data.username}
						</p>
						<p className='text-base text-neutral-900 lg:mb-[6px] lg:self-end'>
