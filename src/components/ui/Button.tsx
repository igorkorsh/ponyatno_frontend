...
const buttonVariants = cva(
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:border-neutral-400 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none aria-invalid:ring-danger/20 aria-invalid:border-danger cursor-pointer",
	{
		variants: {
			variant: {
				default:
				...
				secondary:
					"bg-neutral-200 text-neutral-900 hover:bg-neutral-300 focus-visible:bg-neutral-300",
